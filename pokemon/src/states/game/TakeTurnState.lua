            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- animate the overlap exp filling up
                        self.battleState.playerExpBar:setValue(0)
                        self.battleState.playerExpBar:setMax(self.playerPokemon.expToLevel)
                        Timer.tween(0.5, {
                            [self.battleState.playerExpBar] = {value = self.playerPokemon.currentExp}
                        })
                        ...
                        function()
                            ...
                            gStateStack:push(MenuState({
                                -- player pokemon's stats before level up
                                attack = self.playerPokemon.attack - attackIncrease,
                                hp = self.playerPokemon.HP - HpIncrease,
                                defense = self.playerPokemon.defense - defenseIncrease,
                                speed = self.playerPokemon.speed - speedIncrease,
                            },{
                                -- increase in stats due to level up
