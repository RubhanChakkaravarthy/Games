...
require 'src/states/entity/bee/BeeHorizontalMovingState'
require 'src/states/entity/bee/BeeVerticalMovingState'
...
gTextures = {
    ...
    ['bricks'] = love.graphics.newImage('graphics/doors_and_windows.png'),
}
...
gFrames = {
    ...
    ['flags-poles'] = GenerateQuads(gTextures['flags-poles'], 16, 16),
    ['bricks'] = GenerateQuads(gTextures['bricks'], 16, 16),
}
