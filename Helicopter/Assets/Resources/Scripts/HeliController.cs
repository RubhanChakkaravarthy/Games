...
public class HeliController : MonoBehaviour {
	...
	public Gradient CoinParticleColorGradient;
	public Gradient DiamondParticleColorGradient;
	...
	public void PickupCoin() {
		...
		colorOverLifetime.color = CoinParticleColorGradient;
		ps.Play();
	}
	...
	public void PickupDiamond() {
		...
		var colorOverLifetime = ps.colorOverLifetime;
		colorOverLifetime.color = DiamondParticleColorGradient;
		ps.Play();
	}
